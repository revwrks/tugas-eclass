...
<body>
    <div>
        <nav class="navbar navbar-expand-lg navbar-custom navbar-dark" id="topheader">
            <div class="container">
                <a class="navbar-brand"><img src="assets/logo.png" style="width: 40px" /></a>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="navbar-brand dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"><small><i class="fas fa-user-circle"></i>Welcome
                                <?php if ($_SESSION['level'] == "admin") {
                                    echo $_SESSION['username'];
                                } else {
                                    $_SESSION['gagal-login'] = "Failsafe!";
